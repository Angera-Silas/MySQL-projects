...
# Create an Index on the first and last name 
CREATE INDEX  clientnamesindex  ON Client(ClientFirstName, ClientLastName);
CREATE INDEX authornamesindex ON Author(AuthorFirstName, AuthorLastName);
