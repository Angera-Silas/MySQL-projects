...
WHERE CD_TITLE LIKE '%e' /*this means that the word ends with letter e*/

SELECT CD_TITLE, IN_STOCK FROM COMPACT_DISCS
WHERE CD_TITLE LIKE 'P%'/*The words starts with letter P*/

SELECT CD_TITLE, IN_STOCK FROM COMPACT_DISCS
WHERE CD_TITLE LIKE '_lue'

SELECT CD_ID,CD_TITLE, IN_STOCK FROM COMPACT_DISCS
