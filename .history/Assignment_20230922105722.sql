...
('Peggy','Stevens','190','Bus Driver'),
('Steve','Williamson','1975','HR Cerk'),
('Tyler','Willuamson','1999','Doctor'),
('Izabelle','Williamson','1990','System Analyst'),
('Annabel','Williamson','1960','Cashier'),
('Mohamed','Waters','1966','Insuarance Agent'),
('Marion','Newman','1970','Computer Progr')