...
SELECT ClientFirstName AS First_Name,ClientLastName AS Last_Name,
YEAR(CURRENT_DATE) - ClientDOB AS Age, Occupation FROM Client LIMIT 0,80;

UPDATE TABLE Client SET Occupation=="School Teacher" WHERE ClientID = 80;
